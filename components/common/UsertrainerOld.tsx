"use client"; import { useState, useMemo } from "react"; import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow, } from "@/components/ui/table"; import { Select, SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
...
export default function TrainerAssignment({
  ...
  return (
    <div className="container mx-auto p-6 space-y-4">
      ...
      <h1 className="text-3xl font-bold text-center ">User-Trainer Assignment</h1>
